...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Natalia2408-foreverg.github.io/react_static-list-of-todos-js/) and add it to the PR description.
